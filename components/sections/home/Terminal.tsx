...
export function Terminal({
  ...
  return (
    <div className={`terminal min-w-0 overflow-hidden ${className ?? ""}`}>
      <div className="flex items-center gap-2 border-b border-white/[0.07] px-4 py-3">
        <span
          className="h-[10px] w-[10px] rounded-pill bg-[#ff5f57]"
          aria-hidden="true"
        />
        <span
          className="h-[10px] w-[10px] rounded-pill bg-[#febc2e]"
          aria-hidden="true"
        />
        <span
          className="h-[10px] w-[10px] rounded-pill bg-[#28c840]"
          aria-hidden="true"
        />
            ...
            >
              ...
              {l.t === "kv" && (
                <span>
                  {l.indent ? "    " : "  "}
                  <span className="t-key">&quot;{l.key}&quot;</span>:{" "}
                  <span className={l.kind === "num" ? "t-num" : "t-str"}>
                    {l.value}
                  </span>
                  {l.last ? "" : ","}
                </span>
