    ...
    (
      <div
        style={{
          ...
          background: "linear-gradient(165deg, #250D29 0%, #42174C 55%, #1A0620 100%)",
          color: "#F7F3F9",
          padding: "80px",
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <div style={{ width: 12, height: 12, borderRadius: 999, background: "#C9B8D8" }} />
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ fontSize: 84, lineHeight: 1.05, fontWeight: 700, letterSpacing: -2 }}>
            Banking That Lives
          </div>
          <div style={{ fontSize: 84, lineHeight: 1.05, fontWeight: 700, letterSpacing: -2 }}>
